...
# --------------------------------
@workflow
def faster_rcnn_train_workflow(epochs: int =3, classes:int =3, hf_repo_id: str ="") -> None:
    ...
    trained_model = train_model(model_file=model_file, dataset_dir=dataset_dir, num_epochs=epochs, num_classes=classes)
