...
from union import Artifact, Resources, UnionRemote, task
...
#---------------------------------
def draw_boxes(image, boxes, labels, scores, labels_map, threshold=0.3):
...
# --------------------------------------------------
#TODO make artifact query in a function param
SSDFineTunedModel = Artifact(name="ssd_fine_tuned_model")
